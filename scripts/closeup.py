...
def skin_share(im: Image.Image, share: float) -> float:
    ...
    r, g, b = a[..., 0], a[..., 1], a[..., 2]
    # Условие подобрано под БЛЕДНУЮ кожу тоже. Первая версия требовала
    # заметного перевеса красного над зелёным и не находила лицо вовсе:
    # у нарисованных персонажей оно часто бледно-жёлтое, где r и g почти
    # равны, а отличает кожу от всего прочего именно нехватка синего.
    skin = (r > 140) & (r >= g - 6) & (g > b + 12) & (r - b < 140)
